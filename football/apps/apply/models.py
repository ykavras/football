...
class ReferenceCode(models.Model):
    ...
    piece = models.SmallIntegerField(verbose_name='Adet', default=1)
    ...
    def is_available(self):
        return self.piece > self.total_usage()

    total_usage.short_description = 'Toplam Kullanım'
...
class Application(models.Model):
    ...
    reference_code = models.ForeignKey(ReferenceCode, verbose_name='Referans Kodu', related_name='application',
